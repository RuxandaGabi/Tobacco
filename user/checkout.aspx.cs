...
public partial class user_checkout : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Response.Write("<input type='hidden' name='business' value='ruxandagabi@gmail.com'>");
        ...
        //Response.Write("<input type='hidden' name='return' value='http://localhost:1278/tabacco/user/payment_success.aspx?order="+order_no.ToString()+"'>");
        //Response.Write("</form>");
